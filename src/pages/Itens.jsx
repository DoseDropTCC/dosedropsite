     ...
     <div>
        ...
        <div>
          <ul className="flex text-vermelho text-3xl  gap-40 mt-10 dark:text-amarelo">
            ...
            <li className="-mt-30 ml-10">R$: 67,90</li>
          </ul>
        ...
        <div>
          <ul className="flex text-vermelho text-3xl  gap-40 mt-10 dark:text-amarelo"> 
            ...
            <li className="-mt-30 -ml-32">R$: 69,90</li> 
          </ul>
          <hr className="border-amarelo border-8 dark:border-vermelho -mt-2"/>
        ...
        <div> 
          <ul className="flex text-vermelho text-3xl ml-auto gap-40 mt-10 dark:text-amarelo"> 
            ...
            <li className="-mt-30 -ml-32">R$: 74,60</li>
          </ul>
          <hr className="border-amarelo border-8 dark:border-vermelho -mt-2"/>
        ...
        <div> 
          <ul className="flex text-vermelho text-3xl ml-auto gap-40 mt-10 dark:text-amarelo">
            ...
            <li className="-mt-30 ml-40">R$: 2,50</li> 
          </ul> 
          <hr className="border-amarelo border-8 dark:border-vermelho -mt-2"/>
        ...
        <div> 
          <ul className="flex text-vermelho text-3xl ml-auto gap-40 mt-10 dark:text-amarelo"> 
            ...
            <li className="-mt-30 ml-47">R$: 13,40</li> 
          </ul> 
          <hr className="border-amarelo border-8 dark:border-vermelho -mt-2"/>
        ...
        <div>
          <ul className="flex text-vermelho text-3xl ml-auto gap-40 mt-10 dark:text-amarelo">
            ...
            <li className="-mt-30 ml-13">R$: 101,50</li>
          </ul>
