     ...
     return(
      ...
      <section className="">
         ...
         <div className="flex items-center justify-center gap-20 mt-10 ">
            <h1 className="font-erica text-vermelho text-3xl md:text-5xl lg:text-7xl dark:text-amarelo">Itens Cadastrados</h1>
           ...
           <div>
             <ul className="flex font-erica text-center text-vermelho text-5xl gap-40 mt-10 dark:text-amarelo "> 
              <li className="pl-15 -mt-0 ">Foto</li>
              <li className="pr-50 mt-0">Nome</li> 
              <li className="pl-78 -mt-0">Preço</li> 
           ...
           <div>
            <img src={lapisA} alt="icone de lixeira amarelo" className='rounded-2xl size-30 ml-360 -mt-35'/>
            <img src={lixeiraA} alt="icone de lixeira amarelo" className='rounded-2xl size-30 ml-388 -mt-30'/>
            </div> 
                <div> 
                    <ul className="flex text-vermelho text-5xl ml-auto gap-40 mt-10 dark:text-amarelo">
                    <li className="-mt-33 pl-55">Motor de Passo 28BYJ-48</li>
                    <li className="-mt-33 ml-57">R$: 67,90</li> 
                    </ul> 
                ...
                <div> 
                   <ul className="flex text-vermelho text-5xl ml-auto gap-40 mt-10 dark:text-amarelo">
                    ...
                    <li className="-mt-33 ml-95">R$: 2,50</li> 
                   </ul> 
                    <hr className="border-amarelo border-8 dark:border-vermelho -mt-2"/>
                ...
                <div> 
                   <ul className="flex text-vermelho text-5xl ml-auto gap-40 mt-10 dark:text-amarelo"> 
                    ...
                    <li className="-mt-33 ml-107">R$: 13,40</li> 
                   </ul> 
                    <hr className="border-amarelo border-8 dark:border-vermelho -mt-2"/>
                ...
                <div>
                   <ul className="flex text-vermelho text-5xl ml-auto gap-40 mt-10 dark:text-amarelo">
                    ...
                    <li className="-mt-33 ml-52">R$: 101,50</li>
                   </ul>
